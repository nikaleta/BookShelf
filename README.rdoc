...
* 'Device' - for implementing authentication [link](https://github.com/plataformatec/devise)

* 'CanCan' - for implementing the authorization functionality [link](roles and permission) (https://github.com/ryanb/cancan)

* 'Paperclip' - for implementing the uploading image functionality [link](https://github.com/thoughtbot/paperclip)

* 'Ratyrate' - for implementing the rating functionality [link](https://github.com/wazery/ratyrate)
